...
//==============================================================================
// Immediately-invoked function expression with defensive semi-colon.
// The variable `exports` is assigned to `this` (the `window` object, assuming a 
// browser) at the time of execution.
...
;(function(exports) {
  ...
  // end of graphics ============================ cont. function(exports) ======
  ...
  var animation = exports.animation = {
    ...
    //==========================================================================
    // *this* is back to being `animation`
