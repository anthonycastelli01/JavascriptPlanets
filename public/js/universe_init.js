...
function simulateHome() {
  animation.addSun(0.6955, 0, 0, 0, "jupiter.jpg", { mass: 1.988435e30 });

  animation.addPlanet(0.0024397, 50.32, 0, 0, "neptune.jpg", { mass: 3.30104e23, vel: new THREE.Vector3(0, 0, 4.74e-5) });
  animation.addPlanet(0.0060519, 108.8, 0, 0, "mars.jpg", { mass: 4.86732e24, vel: new THREE.Vector3(0, 0, 3.5e-5) });
  animation.addPlanet(0.0063674447, 150, 0, 0, "neptune.jpg", { mass: 5.9721986e24, vel: new THREE.Vector3(0, 0, 2.963e-5) });
  animation.addPlanet(0.003386, 227.94, 0, 0, "neptune.jpg", { mass: 6.41693e23, vel: new THREE.Vector3(0, 0, 0.0000228175) });
  animation.addPlanet(0.069173, 778.33, 0, 0, "saturn.jpg",  { mass: 1.89813e27, vel: new THREE.Vector3(0, 0, 0.0000129824) });
  animation.addPlanet(0.057316, 1429.4, 0, 0, "saturn.jpg",  { mass: 5.68319e26, vel: new THREE.Vector3(0, 0, 9.280e-6) });
  animation.addPlanet(0.025266, 2870.99, 0, 0, "jupiter.jpg",  { mass: 8.68103e25, vel: new THREE.Vector3(0, 0, 6.509e-6) });
  animation.addPlanet(0.024553, 4504, 0, 0, "mars.jpg",  { mass: 1.0241e26, vel: new THREE.Vector3(0, 0, 5.449e-6) });
